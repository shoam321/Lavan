    ...
    <main className="fixed inset-0 flex items-center justify-center" style={{direction: 'ltr'}}>
      ...
      <div className="relative z-10" style={{direction: 'rtl'}}>
        ...
        <div className="px-[18px] py-6">
          <div className="flex flex-col items-center justify-center mb-3" style={{backdropFilter: 'blur(10px)', padding: '16px', borderRadius: '16px', backgroundColor: 'rgba(255,255,255,0)', border: '1.5px solid rgba(255,255,255,0.1)'}}>
