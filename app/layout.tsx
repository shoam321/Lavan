...
// הוסרו ייבואים ספציפיים ל-Next.js שגורמים לשגיאות קומפילציה בסביבה זו
// import { Geist, Geist_Mono } from "next/font/google"
// import { Analytics } from "@vercel/analytics/next"
// import Script from "next/script"
// import "./globals.css" // התוכן של קובץ זה הוטמע ישירות למטה
...
// 1. זהו התוכן המלא של globals.css
// הוא הוטמע כאן כדי למנוע את שגיאת הייבוא
const globalStyles = `
  @import 'tailwindcss';
...
export default function RootLayout({
  ...
  return (
    <html lang="he" dir="rtl">
      <head>
        {/* 3. הטמעתי את העיצוב ישירות כאן */}
        <style dangerouslySetInnerHTML={{ __html: globalStyles }} />
      </head>
      {/* 4. הקלאס 'site-bg' יעבוד עכשיו */}
      <body className={`font-sans antialiased site-bg`}>
        {children}
        {/* <Analytics />  // הוסר כי הייבוא נכשל */}

        {/* 5. הטמעתי את סקריפט הנגישות שלך כאן */}
        <script
